...
from env_threefinger import Env
...
ROBOT_URDF = os.path.join(HERE, 'data', 'threefingerv7', 'urdf', 'threefingerv7.urdf')
...
gripper_main_control_joint_name = [
                    ]

mimic_joint_name = ["11_joint",
                    "21_joint",
                    "31_joint",
                    "12_joint2",
                    "22_joint2",
...
success = True
try:
    # p.applyExternalForce(env.robotID,6, [0,0,0], [0,0,0.3], p.WORLD_FRAME)

    env.open_gripper(env.robotID, env.joints, gripper_main_control_joint_name, mimic_joint_name, 0.1, 0.5)
    ...
    env.close_gripper(env.robotID, env.joints, gripper_main_control_joint_name, mimic_joint_name, -0.1, -0.6)
