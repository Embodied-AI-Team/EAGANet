...
ROBOT_URDF = os.path.join(HERE, 'data', 'pandas', 'panda_gripper.urdf')
...
try:
    ...
    env.open_gripper(env.robotID, env.joints, gripper_main_control_joint_name, mimic_joint_name, 0.04, 0.04)
    ...
    env.close_gripper(env.robotID, env.joints, gripper_main_control_joint_name, mimic_joint_name, 0, 0)
