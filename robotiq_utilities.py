...
class GoogleModels(Models):
    ...
    def load_objects(self):
        ...
        for filename in self.obj_files:
            objectid = load_model(filename, ([0.0, 0, 0.1], [0, 0, 0, 1]))
...
def setup_sisbot(p, robotID, gripper_type):
    controlJoints = ["x_joint", "y_joint",
                     "z_joint", "x_rotation_joint",
    ...
    for i in range(numJoints):
        ...
        if controllable:
            gripper_actor_ids.append(info[0])
    ...
    return joints, controlRobotiqC2, controlJoints, mimicParentName, gripper_actor_ids
